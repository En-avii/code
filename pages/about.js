...
import { FaLaptop, FaLinkedin, FaTwitter } from "react-icons/fa";
  ...
  return (
    <div className="min-h-screen relative bg-white dark:bg-gray-900">
      ...
      <div className="max-w-2xl pt-20 pb-32 px-6 text-center mx-auto">
        ...
        I am a self-taught developer currently pursuing a degree in Electronics and Communication Engineering (ECE) at IIIT Manipur.
        I am passionate about technology and constantly strive to enhance my skills by working on various projects and exploring new technologies.
        </p>
        ...
        <div className="text-center pt-8">
          ...
          <button className="bg-indigo-500 px-3 py-1 font-semibold text-white inline-flex items-center space-x-2 rounded ml-3 dark:bg-indigo-600">
            ...
            <a
              ...
              rel="noopener noreferrer"
              target="_blank"
              href="https://linkedin.com/in/enaviii04"
            >
              Follow Me
            </a>
          </button>
