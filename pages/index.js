...
export default function Home({ blogs, topics }) {
  return (
    <>
      <Head>
        <title>Let's Decode 🚀</title>
        <meta name="title" content="Let's Decode🚀" />
        <meta
          name="description"
        ...
        <meta property="og:title" content="Let's Decode🚀" />
        <meta
        ...
        <meta property="twitter:title" content="Let's Decode🚀" />
        <meta
